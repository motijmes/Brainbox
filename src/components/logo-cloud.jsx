...
const LogoCloud = () => {
  return (
    <div className="py-8 backdrop-blur-sm sm:py-12 lg:py-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto grid grid-cols-2 gap-8 sm:grid-cols-4 md:grid-cols-5 lg:hidden">
          <img
            ...
            width={158}
            height={48}
            className="h-8 w-auto bg-black object-contain"
          />
          <img
            alt="Keller Williams"
        ...
        <div className="mt-8 flex justify-center sm:mt-10">
          <p className="relative rounded-full border-primary-2 bg-primary-1/5 px-4 py-1.5 text-sm/6 text-primary-2 ring-1">
            <span className="hidden md:inline">
              Trusted by thousands of real estate professionals nationwide.{' '}
            </span>
            <a
              href="#"
              className="font-semibold text-primary-2 hover:text-hover-1"
            >
